...
public class DBService {
	...
	public void instanciaDB() {
		...
		Cliente cli2 = new Cliente(null, "Alan Cliente", "322.429.140-06", "alan-cli@gmail.com", encoder.encode("123"));
		Cliente cli3 = new Cliente(null, "Arthur Cliente", "792.043.830-62", "arthur-cli@gmail.com", encoder.encode("123"));
		Cliente cli4 = new Cliente(null, "Cauê Cliente", "177.409.680-30", "caue-cli@gmail.com", encoder.encode("123"));
		Cliente cli5 = new Cliente(null, "Idas Cliente", "081.399.300-83", "idas-cli@gmail.com", encoder.encode("123"));
